...
func (d *EncoderDecoder06) Encode(file *os.File, lmf dataformat.LayerMetadataFile) error {
...
func (d *EncoderDecoder06) Decode(path string) (dataformat.LayerMetadataFile, string, error) {
	...
	return dataformat.LayerMetadataFile{Data: lmtf.Data, Build: lmtf.Types.Build, Launch: lmtf.Types.Launch, Cache: lmtf.Types.Cache}, msg, nil
}
